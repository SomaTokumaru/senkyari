...
function showResult() {
    ...
    resultElement.innerText = "\u3042\u306A\u305F\u306E\u30B9\u30B3\u30A2: ".concat(totalScore, " / 4");
    resultElement.style.display = "block";
}
var choicesElements = document.querySelectorAll('.choice-label input[type="radio"]');
choicesElements.forEach(function (choiceElement) {
    choiceElement.addEventListener('change', function () {
        var selectedValue = parseInt(choiceElement.value);
