...
// 問題文とボタンのセットを定義
const quizData = [
  { question: "嫌なことがあっても<wbr>すぐに切り替えられる。" },
  { question: "何を言うかよりも<wbr>誰が言うかが重要だと思う。" },
  { question: "人のために尽くしたいと思う。" },
  { question: "嫌なことも許容できる方だと思う。" },
  { question: "他人とコミュニケーションを<wbr>とることは得意だ。" },
  { question: "人と信頼関係を構築するのは得意だ。" },
  { question: "自分のチャレンジを<wbr>応援してくれる人がいる。" },
  { question: "協調性を持っていると思う。" },
  { question: "住んでいる地域の人間関係は良好だ。" },
  { question: "職場や学校、家庭は温かい雰囲気だ。" },
