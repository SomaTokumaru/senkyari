...
// 問題文とボタンのセットを定義
const quizData = [
  { question: "アイディアを出したり企画を<wbr>するのは好きだ。" },
  { question: "人と接することが好きだ。" },
  { question: "数字やデータを扱うことは好きだ。" },
  { question: "分析や計画を立てることは好きだ。" },
  { question: "物理的な作業や<wbr>手を使う仕事に興味がある。" },
  { question: "安定した環境で働くことを重視する。" },
  { question: "技術やITに関わる仕事に興味がある。" },
  { question: "社会貢献や人々の<wbr>役に立つ仕事に興味がある。" },
  { question: "日々変化のない仕事を好む。" },
];
